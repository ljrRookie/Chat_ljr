...
import com.ljr.chat_ljr.frags.panel.PanelFragment;
import com.ljr.common.adapter.TextWatcherAdapter;
...
// Todo 语音回调
    ...
    @OnClick({R.id.btn_face, R.id.btn_record})
        ...
        protected void onBind(Message message) {
            ...
            if (mLoading != null) {
                ...
                if (status == Message.STATUS_DONE) {
                    ...
                    mRePush.setVisibility(View.GONE);
                    ...
                    mRePush.setVisibility(View.VISIBLE);
                }
